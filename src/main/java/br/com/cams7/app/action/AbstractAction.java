package br.com.cams7.app.action;
 ...
 * 
 * <p>
 * A ação é representada por <code>AbstractAction</code>, um tipo de componente
 * complementar ao <code>MVC</code> (<strong>M</strong>odel <strong>V</strong>
 * iew <strong>C</strong>ontroller), um modelo arquitetural utilizado para
...
public abstract class AbstractAction {
	 ...
	 * <code>action</code>, <code>preAction</code> ou <code>posAction</code>.
	 */
