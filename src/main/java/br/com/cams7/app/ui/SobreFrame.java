...
import static br.com.cams7.app.util.ApplicationProperties.getBuild;
import static br.com.cams7.app.util.ApplicationProperties.getDesenvolvidoPor;
import static br.com.cams7.app.util.ApplicationProperties.getSite;
import static br.com.cams7.app.util.ApplicationProperties.getTitulo;
import static br.com.cams7.app.util.ApplicationProperties.getURLLogo;
import static br.com.cams7.app.util.ApplicationProperties.getVersao;
...
public class SobreFrame extends JFrame {
	...
	private JPanel montaLabelsSobre() {
		...
		panelLayout.setHorizontalGroup(panelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(createHorizontalGroup(panelLayout, 33, groupComponents(panelLayout, l1, l2, l3, l4, l5),
						groupComponents(panelLayout, lTitulo, lVersao, lDesenvPor, lBuild, lSite)).addComponent(logo,
		...
		panelLayout.setVerticalGroup(panelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(panelLayout
				...
				.addGroup(panelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
						...
						.addGroup(createVerticalGroup(panelLayout, groupComponents(panelLayout, l1, lTitulo),
								...
								groupComponents(panelLayout, l4, lBuild), groupComponents(panelLayout, l5, lSite))))
